...
{
    [SHUIHelper showTextMessage:message inView:[UIApplication sharedApplication].keyWindow];
}
...
{
    [SHUIHelper showWaitingMessage:message inView:[UIApplication sharedApplication].keyWindow];
}
...
{
    [SHUIHelper hideWaitingMessage:message inView:[UIApplication sharedApplication].keyWindow];
}
...
+ (UIBarButtonItem *)createButtonItemWithTitle:(NSString *)title target:(id)target selector:(SEL)selector
{
    UIBarButtonItem *item = [[UIBarButtonItem alloc] initWithTitle:title
                                                            ...
                                                            target:target
                                                            action:selector];
    [SHUIHelper configFlatForBarButtonItem:item];
